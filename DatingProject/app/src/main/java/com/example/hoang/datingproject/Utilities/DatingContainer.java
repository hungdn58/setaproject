...
import com.example.hoang.datingproject.Fragment.DatingFragment;
import com.example.hoang.datingproject.R;

/**
 * Created by hoang on 4/4/2016.
 */
public class DatingContainer extends BaseContainerFragment {
    ...
    public void initView(){
        replaceFragment(new DatingFragment(), false);
    }
}
