...
//        progressDialog.show();
        ...
        arrUrls.add("http://vnreview.vn/feed/-/rss/home");
        arrUrls.add("http://vnreview.vn/feed/-/rss/13612");
        arrUrls.add("http://vnreview.vn/feed/-/rss/13612/13622");
        arrUrls.add("http://vnreview.vn/feed/-/rss/13612/13621");
        arrUrls.add("http://vnreview.vn/feed/-/rss/13612/13620");
        arrUrls.add("http://vnreview.vn/feed/-/rss/13612/13619");
        arrUrls.add("http://vnreview.vn/feed/-/rss/13612/13618");
        arrUrls.add("http://vnreview.vn/feed/-/rss/13612/13616");
        arrUrls.add("http://vnreview.vn/feed/-/rss/13612/13615");
        arrUrls.add("http://vnreview.vn/feed/-/rss/13612/1327536");
        arrUrls.add("http://vnreview.vn/feed/-/rss/13414/13419");
        arrUrls.add("http://vnreview.vn/feed/-/rss/13414/245386");
        arrUrls.add("http://vnreview.vn/feed/-/rss/13414/13418");
        arrUrls.add("http://vnreview.vn/feed/-/rss/13414/26512");
        arrUrls.add("http://vnreview.vn/feed/-/rss/13414/13417");
        arrUrls.add("http://vnreview.vn/feed/-/rss/13414/13416");
        arrUrls.add("http://vnreview.vn/feed/-/rss/13414/13415");
        arrUrls.add("http://vnreview.vn/feed/-/rss/13414/542370");
        arrUrls.add("http://vnreview.vn/feed/-/rss/13414/1347138");
        arrUrls.add("http://vnreview.vn/feed/-/rss/13626");
        arrUrls.add("http://vnreview.vn/feed/-/rss/487801");
        arrUrls.add("http://vnreview.vn/feed/-/rss/186935/186936");
        arrUrls.add("http://vnreview.vn/feed/-/rss/186935/1175350");
        arrUrls.add("http://vnreview.vn/feed/-/rss/13612/13617");

        viewPager.setOffscreenPageLimit(arrUrls.size());


        arrTitles.add("Trang Chủ");
        arrTitles.add("Đánh Giá");
        arrTitles.add("Di Động");
        arrTitles.add("Đồ Gia Dụng");
        arrTitles.add("Laptop");
        arrTitles.add("Máy Ảnh Số");
        arrTitles.add("Máy Tính Bảng");
        arrTitles.add("Tivi");
        arrTitles.add("Top 10");
        arrTitles.add("Phụ Kiện");
        arrTitles.add("An Ninh Mạng");
        arrTitles.add("Khoa Học Công Nghệ");
        arrTitles.add("Kinh Doanh");
        arrTitles.add("Ở Đâu Có Gì");
        arrTitles.add("Sản Phẩm Mới");
        arrTitles.add("Thị Trường");
        arrTitles.add("Xã Hội Số");
        arrTitles.add("Ảnh");
        arrTitles.add("Xe");
        arrTitles.add("Tư Vấn");
        arrTitles.add("Góc Nhìn VnReview");
        arrTitles.add("Hỏi Đáp Máy Tính");
        arrTitles.add("Hỏi Đáp Mobile");
        arrTitles.add("Theo Yêu Cầu");
