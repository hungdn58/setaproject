...
//        progressDialog.show();
        ...
        arrUrls.add("http://ngoisao.net/rss/hau-truong.rss");
        arrUrls.add("http://ngoisao.net/rss/ben-le.rss");
        arrUrls.add("http://ngoisao.net/rss/thoi-cuoc.rss");
        arrUrls.add("http://ngoisao.net/rss/phong-cach.rss");
        arrUrls.add("http://ngoisao.net/rss/thu-gian.rss");
        arrUrls.add("http://ngoisao.net/rss/cuoi-hoi.rss");
        arrUrls.add("http://ngoisao.net/rss/showbiz-viet.rss");
        arrUrls.add("http://ngoisao.net/rss/chau-a.rss");
        arrUrls.add("http://ngoisao.net/rss/hollywood.rss");
        arrUrls.add("http://ngoisao.net/rss/clip.rss");
        arrUrls.add("http://ngoisao.net/rss/khoe-dep.rss");
        arrUrls.add("http://ngoisao.net/rss/24h.rss");
        arrUrls.add("http://ngoisao.net/rss/chuyen-la.rss");
        arrUrls.add("http://ngoisao.net/rss/hinh-su.rss");
        arrUrls.add("http://ngoisao.net/rss/thuong-truong.rss");
        arrUrls.add("http://ngoisao.net/rss/thoi-trang.rss");
        arrUrls.add("http://ngoisao.net/rss/lam-dep.rss");
        arrUrls.add("http://ngoisao.net/rss/trac-nghiem.rss");
        arrUrls.add("http://ngoisao.net/rss/an-choi.rss");
        arrUrls.add("http://ngoisao.net/rss/dan-choi.rss");
        arrUrls.add("http://ngoisao.net/rss/cuoi.rss");
        arrUrls.add("http://ngoisao.net/rss/game.rss");
        arrUrls.add("http://ngoisao.net/rss/miss.rss");
        arrUrls.add("http://ngoisao.net/rss/cam-nang.rss");

        viewPager.setOffscreenPageLimit(arrUrls.size());


        arrTitles.add("Hậu Trường");
        arrTitles.add("Bên Lề");
        arrTitles.add("Thời Cuộc");
        arrTitles.add("Phong Cách");
        arrTitles.add("Thư Giãn");
        arrTitles.add("Cưới Hỏi");
        arrTitles.add("Showbiz");
        arrTitles.add("Châu Á");
        arrTitles.add("Hollywood");
        arrTitles.add("Clip");
        arrTitles.add("Khỏe Đẹp");
        arrTitles.add("24H");
        arrTitles.add("Chuyện Lạ");
        arrTitles.add("Hình Sự");
        arrTitles.add("Thương Trường");
        arrTitles.add("Thời Trang");
        arrTitles.add("Làm Đẹp");
        arrTitles.add("Trắc Nghiệm");
        arrTitles.add("Ăn Chơi");
        arrTitles.add("Dân Chơi");
        arrTitles.add("Cười");
        arrTitles.add("Game");
        arrTitles.add("Miss");
        arrTitles.add("Cẩm Nang");
