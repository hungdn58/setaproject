...
Router::scope('/', function (RouteBuilder $routes) {
    ...
    $routes->connect('/notification/post', ['controller' => 'Notifications', 'action' => 'add']);
    $routes->connect('/notification/footprint.json', ['controller' => 'Footprints', 'action' => 'index']);
    $routes->connect('/notification/footprint/post', ['controller' => 'Footprints', 'action' => 'add']);
    $routes->connect('/user/profile.json', ['controller' => 'Users', 'action' => 'index']);
    $routes->connect('/user/post', ['controller' => 'Users', 'action' => 'add']);
    $routes->connect('/user/list.json', ['controller' => 'Users', 'action' => 'index']);
    $routes->connect('/user/update/:nickname', ['controller' => 'Users', 'action' => 'updateID'], ['pass' => array('nickname')]);
    $routes->connect('/user/profile/update/:id', ['controller' => 'Users', 'action' => 'edit'], ['pass' => array('id')]);
    $routes->connect('/user/profile/delete/:id', ['controller' => 'Users', 'action' => 'delete'], ['pass' => array('id')]);
    ...
    $routes->connect('/timeline/profile/list.json', ['controller' => 'Items', 'action' => 'getMyItem']);
    $routes->connect('/timeline/delete/:id', ['controller' => 'Items', 'action' => 'delete'], ['pass' => array('id')]);
